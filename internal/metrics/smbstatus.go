...
func RunSmbStatusShares() ([]SmbStatusTCon, error) {
	...
	return parseSmbStatusTCons(dat)
}

func parseSmbStatusTCons(dat string) ([]SmbStatusTCon, error) {
	tcons := []SmbStatusTCon{}
...
func makeSmbSharesMap(tcons []SmbStatusTCon) map[string][]SmbStatusTCon {
